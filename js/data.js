...
const qnaList = [
  ...
  {
    q: '"꺄아악 마법테러다!" 수상한 자를 상대하고 있는 사이 어디선가 큰 소란이 났다는걸 알게 된 당신, 당신이 가장 먼저 할 일은?',
    a: [
  ...
  {
    q: '잡았다!! 마법테러를 일으킨 악당을 잡는데에 성공한 당신. 당신은 그를 잡는데에 어느정도의 힘을 사용했나요?',
    a: [
...
const infoList = [
  ...
  },
  {
    ...
    test: `
        ...
        당신이 더 큰 목표를 이루기 위해서는 자신의 성장이 필요하다는 사실을 알고있기에 자기 계발을 위해 시간과 에너지를 투자해야합니다.

        <div class="tac"><span class="badge">유연성과 적응력</span></div>
        당신은 변화와 도전에 유연하게 대처하며, 적응력을 갖추고 있습니다. 당신은 새로운 상황에 빠르게 적응하고, 변화를 기회로 여깁니다.
    `
  },
  {
    name: '이단자',
